#EJERCICIO_01
monto_total_de_un_empleado=548.8
type_monto_total_de_un_empleado=type(monto_total_de_un_empleado)

monto_total_de_un_empleado_es_float=isinstance(monto_total_de_un_empleado,float)
monto_total_de_un_empleado_es_str=isinstance(monto_total_de_un_empleado,str)

print("variable monto total de un empleado es:",type_monto_total_de_un_empleado)
print("variable es float?:",monto_total_de_un_empleado_es_float)
print("variable es str?:",monto_total_de_un_empleado_es_str)


#EJERCICIO_02
monto_total_de_un_ganadero=289.60
type_monto_total_de_un_ganadero=type(monto_total_de_un_ganadero)

monto_total_de_un_ganadero_es_float=isinstance(monto_total_de_un_ganadero,float)
monto_total_de_un_ganadero_es_int=isinstance(monto_total_de_un_ganadero,int)

print("variable monto total de un ganadero es:",type_monto_total_de_un_ganadero)
print("variable es float?:",monto_total_de_un_ganadero_es_float)
print("variable es int?:",monto_total_de_un_ganadero_es_int)


#EJERCICIO_03
ingreso_total_de_una_consultora_natura=557.98
type_ingreso_total_de_una_consultora_natura=type(ingreso_total_de_una_consultora_natura)

ingreso_total_de_una_consultora_natura_es_float=isinstance(ingreso_total_de_una_consultora_natura,float)
ingreso_total_de_una_consultora_natura_es_str=isinstance(ingreso_total_de_una_consultora_natura,str)
...
#EJERCICIO_36
venta_total_en_el_mes_de_marzo=489.90
type_venta_total_en_el_mes_de_marzo=type(venta_total_en_el_mes_de_marzo)

type_venta_total_en_el_mes_de_marzo_es_float=isinstance(venta_total_en_el_mes_de_marzo,float)
type_venta_total_en_el_mes_de_marzo_es_str=isinstance(venta_total_en_el_mes_de_marzo,str)
...
#EJERCICO_38
venta_total_en_el_mes_de_mayo=257.90
...
#EJERCICIO_39
venta_total_en_el_mes_de_junio=357.90
...
#EJERCCICIO_41
venta_total_en_el_mes_de_agosto=3658.90
type_venta_total_en_el_mes_de_agosto=type(venta_total_en_el_mes_de_agosto)

type_venta_total_en_el_mes_de_agosto_es_float=isinstance(venta_total_en_el_mes_de_agosto,float)
type_venta_total_en_el_mes_de_agosto_es_str=isinstance(venta_total_en_el_mes_de_agosto,str)

print("variable venta total en el mes de agosto:",type_venta_total_en_el_mes_de_agosto_es_float)
print("variable es float?:",type_venta_total_en_el_mes_de_agosto_es_float)
print("variable es str?:",type_venta_total_en_el_mes_de_agosto_es_str)


#EJERCICIO_42
venta_total_en_el_mes_de_setiembre=3579.23
type_venta_total_en_el_mes_de_setiembre=type(venta_total_en_el_mes_de_setiembre)

type_venta_total_en_el_mes_de_setiembre_es_float=isinstance(venta_total_en_el_mes_de_setiembre,float)
type_venta_total_en_el_mes_de_setiembre_es_str=isinstance(venta_total_en_el_mes_de_setiembre,str)
...
#EJERCICIO_47
numero_de_alumnos_de_dicisiete_anios=58
type_numero_de_alumnos_de_dicisiete_anios=type(numero_de_alumnos_de_dicisiete_anios)

type_numero_de_alumnos_de_dicisiete_anios_es_int=isinstance(numero_de_alumnos_de_dicisiete_anios,int)
type_numero_de_alumnos_de_dicisiete_anios_es_str=isinstance(numero_de_alumnos_de_dicisiete_anios,str)
